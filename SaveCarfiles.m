...
Car.AeroPerformance.SC_L = 2.4;
Car.AeroPerformance.SC_D = 1.38;
...
Car.Brakes.Rear.aMasterCylinder = pi*(Car.Brakes.Rear.dMasterCylinder/2)^2;
% Car aero performance
Car.AeroPerformance.SC_L = 0.05;
Car.AeroPerformance.SC_D = 1.15;
Car.AeroPerformance.hRideF = 0.038;     % (m) (Static ride height under the weight of the car)
Car.AeroPerformance.hRideR = 0.038;     % (m)
% Steering
Car.Steering.Ratio = 7;
...
Car.Brakes.Rear.aMasterCylinder = pi*(Car.Brakes.Rear.dMasterCylinder/2)^2;
% Car aero performance
Car.AeroPerformance.SC_L = 2.64;       
Car.AeroPerformance.SC_D = 1.62;
Car.AeroPerformance.hRideF = 0.038;     % (m) (Static ride height under the weight of the car)
Car.AeroPerformance.hRideR = 0.038;     % (m)
% Steering
Car.Steering.Ratio = 7;
...
Car.Dimension.Height = 1.460;
Car.AeroPerformance.SC_L = 2.88;         
Car.AeroPerformance.SC_D = 1.488;
Car.AeroPerformance.hRideF = 0.038; % (m) (Static ride height under the weight of the car)
Car.AeroPerformance.hRideR = 0.038; % (m)
...
Car.Dimension.WheelRR.Radius = 0.230;
%Aero
Car.AeroPerformance.SC_L = 3.6;
Car.AeroPerformance.SC_D = 1.68;
Car.AeroPerformance.hRideF = 0.038; % (m) (Static ride height under the weight of the car)
Car.AeroPerformance.hRideR = 0.038; % (m)
% Steering
Car.Steering.Ratio = 7;
...
%Aero
Car.AeroPerformance.C_L = 4.2; 
Car.AeroPerformance.C_D = 1.38;      
Car.AeroPerformance.hRideF = 0.038; % (m) (Static ride height under the weight of the car)
Car.AeroPerformance.hRideR = 0.038; % (m)
% Steering
Car.Steering.Ratio = 7;
...
Car.Dimension.WheelRR.Radius = 0.2032;
%Aero
Car.AeroPerformance.SC_L = 0.2;
Car.AeroPerformance.SC_D = 1.2;
Car.AeroPerformance.hRideF = 0.03; % (m) (Static ride height under the weight of the car)
Car.AeroPerformance.hRideR = 0.03; % (m)
% Steering
Car.Steering.Ratio = 7;
