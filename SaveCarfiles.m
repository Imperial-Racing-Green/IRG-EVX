...
Car.AeroPerformance.C_D = 0.486;                        % unknown
...
Car.Powertrain.Motor.TransmissionRatio = 3.82;                               % Gear Ratio
...
Car.Powertrain.Motor.TransmissionRatio = 6.39;                              % 6.39;                %Gear Ratio
...
Car.AeroPerformance.C_L = 2.7;                          % unknown
Car.AeroPerformance.C_D = 0.8; %1.24;                         % unknown
...
Car.Powertrain.Motor.P_Max = 0;                       % Max power (W)
Car.Powertrain.Engine.Config = 'rwd';
Car.Powertrain.Engine.TransmissionRatio = 29/11;                               % Gear ratio
...
Car.Powertrain.Motor.P_Max = 0;                       % Max power (W)
Car.Powertrain.Engine.Config = 'rwd';
Car.Powertrain.Engine.TransmissionRatio = 2;                               % Gear ratio
