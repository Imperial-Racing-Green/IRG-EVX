...
k_SFR = 5000; %suspension stiffness front right (N/m)
k_SFL = 5000; %suspension stiffness front left (N/m)
k_SRR = 5000; %suspension stiffness rear right (N/m)
k_SRL = 5000; %suspension stiffness rear left (N/m)
...
c_SFR = 100; %suspension damping coefficient front right (Ns/m)
c_SFL = 100; %suspension damping coefficient front left (Ns/m)
c_SRR = 100; %suspension damping coefficientv rear right (Ns/m)
c_SRL = 100; %suspension damping coefficient rear left (Ns/m)
